...
public class Sorting
{
    ...
    {
        final long startTime = System.currentTimeMillis(); //record the time at the start of the program
        ...
        final long endTime = System.currentTimeMillis(); //takes the time at the end of the execution of the algorithm
        System.out.println("\nThe array has now been sorted: ");
        printArray(data);
        System.out.println("Comparisons: " + comparisonCounter + ", Swaps: " + swapCounter + ", Total run time: " + (endTime-startTime) + "\n"); //prints out the comparisons, swaps and run time
    ...
    {
        long startTime = System.currentTimeMillis(); //takes the time at the beginning of execution
        ...
        long endTime = System.currentTimeMillis();// get the time at the end of execution
    ...
    void bubbleSortRuntime(T[] data, String type)
    {
        ...
        long endTime = System.currentTimeMillis();
        System.out.println("Comparisons: " + comparisonCounter + ", Swaps: " + swapCounter + ", Total run time: " + ( System.currentTimeMillis()-startTime) + "\n");
    }
